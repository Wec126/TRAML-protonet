...
def load_glove_vectors(glove_file):
    ...
    print("Loaded {} words".format(len(glove_vectors)))
...
def main():
    ...
    loss_fn = PrototypicalLoss(glove_vectors,options.num_support_tr, options.num_query_tr, options.classes_per_it_tr)
    eval_loss_fn = PrototypicalLoss(glove_vectors,options.num_support_tr, options.num_query_tr, options.classes_per_it_val,
                                    is_train=False)
