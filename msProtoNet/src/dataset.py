...
class OmniglotDataset():
    ...
    def __init__(self, mode='train', root='C:\\Users\\lhs\Desktop\\ai框架\models-r1.9\\research\\cv\\ProtoNet\\dataset', transform=None, target_transform=None):
        self.root = 'D:\demo\Prototypical-Networks-for-Few-shot-Learning-PyTorch-master\Prototypical-Networks-for-Few-shot-Learning-PyTorch-master\dataset'
        print(self.root)
